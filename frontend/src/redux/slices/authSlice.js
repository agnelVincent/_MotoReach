...
export const registerUser = createAsyncThunk(
    ...
    async (userData, { rejectWithValue }) => {
        try {
            const response = await axiosInstance.post('accounts/register/user/', userData)
            return response.data
        }
        catch (error) {
            if (error.response && error.response.data) {
...
export const registerMechanic = createAsyncThunk(
    ...
    async (userData, { rejectWithValue }) => {
        try {
            const response = await axiosInstance.post('accounts/register/mechanic/', userData)
            return response.data
        }
        catch (error) {
            if (error.response && error.response.data) {
...
export const registerWorkshop = createAsyncThunk(
    ...
    async (userData, { rejectWithValue }) => {
        try {
            const response = await axiosInstance.post('accounts/register/workshop/', userData)
            return response.data
        }
        catch (error) {
            if (error.response && error.response.data) {
        ...
        builder
            ...
            .addCase(loginUser.fulfilled, (state, action) => {
                ...
                const userData = {
                    ...
                    workshop_status: action.payload.workshop_status
                }
                state.user = userData
            ...
            .addCase(registerWorkshop.pending, (state) => {
                state.loading = true
                state.error = false
                state.isRegistered = false
            })
            ...
            .addCase(registerWorkshop.rejected, (state, action) => {
                state.error = action.payload
                state.loading = false
                state.isRegistered = false
            })
