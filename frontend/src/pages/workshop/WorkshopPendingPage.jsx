    ...
    return (
        ...
        <div className="flex justify-center items-center min-h-screen p-4 md:p-8 bg-gray-900 mt-10">
            ...
            <div className="max-w-3xl w-full bg-white rounded-2xl shadow-2xl overflow-hidden transform transition duration-500 hover:shadow-3xl">
                ...
                <div className="p-8 md:p-12 text-white bg-gradient-to-r from-yellow-500 to-orange-400 text-center">
                ...
                <div className="p-8 md:p-12">
                    ...
                    {/* Status Box */}
                    <div className="mb-10 p-5 bg-yellow-50 border border-yellow-200 rounded-lg text-left">
                        <div className="flex items-center">
                            <ExclamationCircleIcon className="w-6 h-6 text-yellow-600 mr-3" />
                            <p className="text-lg font-semibold text-yellow-800">
                                Current Status: <span className="text-yellow-600">PENDING</span>
                            </p>
                        </div>
                    </div>
