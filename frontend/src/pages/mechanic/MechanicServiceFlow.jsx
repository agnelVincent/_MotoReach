  ...
  return (
    <div className="min-h-screen bg-[#f8f9fc] font-sans">
      <style>{`
        ...
        .hero-gradient { background: linear-gradient(135deg, #0f172a 0%, #1e1b4b 40%, #312e81 70%, #1e3a5f 100%); }
        .hero-noise::before {
        ...
        .sf-card { background: white; border-radius: 1rem; border: 1px solid #f1f5f9; transition: box-shadow 0.25s ease; }
      ...
      <section className="hero-gradient hero-noise relative overflow-hidden">
        <div className="glow-dot w-96 h-96 bg-indigo-500 opacity-20 top-[-60px] left-[-40px]" />
          ...
          <div className={`flex flex-wrap items-center justify-between gap-3 mb-4 opacity-0 ${mounted ? 'animate-fade-up' : ''}`}>
            <div className="flex items-center gap-3">
              ...
              <h1 className="font-display text-2xl sm:text-3xl font-bold text-white leading-tight">
                Service{' '}
                <span className="bg-gradient-to-r from-violet-300 to-indigo-200 bg-clip-text text-transparent">Flow</span>
              </h1>
            </div>
            ...
            <div className="overflow-x-auto pb-0">
              <div className="min-w-[580px] md:min-w-0 relative flex items-start justify-between py-3">
                ...
                <div
                  ...
                  style={{ width: `${(getCurrentStatusIndex() / (statusFlow.length - 1)) * 100}%`, background: 'linear-gradient(90deg,#4f46e5,#7c3aed)' }}
                />
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-5">
        <div className="flow-grid">
          ...
          <div className="flex flex-col gap-3">
            ...
            {/* ── ACTIONS SECTION ── */}
            <div className="sf-card p-4 space-y-2.5">
                        ...
                        toast((t) => (
                          <div className="flex flex-col gap-3">
                            ...
                            <div className="flex gap-2">
                              <button onClick={() => toast.dismiss(t.id)} className="flex-1 px-3 py-1.5 text-sm border border-gray-200 rounded-lg text-gray-600 font-medium hover:bg-gray-50">Cancel</button>
                              ...
                              }} className="flex-1 px-3 py-1.5 text-sm bg-emerald-600 hover:bg-emerald-700 text-white rounded-lg font-semibold">Confirm</button>
                            </div>
                          </div>
                        ), { position: 'top-center' });
                      }}
